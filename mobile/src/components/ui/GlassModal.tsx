// Copied from web/src/components/ui/GlassModal.tsx — 'use client' stripped
// (Next.js-specific marker, no-op in Vite).
...
interface GlassModalProps {
  ...
  /** Lock the modal panel to a fixed height on tablet+ viewports */
